...
public class ElevatorController {
    ...
    private Elevator findCommittedToFloor(Request request){
        ...
        for(Elevator e: elevators){
            ...
            if((direction == Direction.UP && e.getCurrentFloor() > floor) || (direction == Direction.DOWN && e.getCurrentFloor() < floor)){
                continue;
            }
    ...
    public boolean selectFloor(int elevatorIndex, int floor){
        ...
        return elevators.get(elevatorIndex).addRequest(request);
    }
